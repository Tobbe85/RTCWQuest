...
typedef struct {
	...
	/*unsigned*/ char infoScreenText[MAX_STRING_CHARS]; /*SEB*/
	...
	int centerPrintY;
	/*unsigned*/ char centerPrint[1024]; /*SEB*/
...
#ifdef AUTOAIM
void        trap_SetUserCmdValue( int stateValue, int holdableValue, float sensitivityScale, int cld, int lastFire, int crossHairStatus );
#else
